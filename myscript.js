 ...
 */
 ...
 for (let i=1; i<101; i++){
     ...
     const square = `<li style="padding:25px;color:black; background-color:#1389B2;" class= "box mb-3 me-3 d-flex justify-content-center box--${i}">${i}</li>`;
     //se funziona,
     //console.log(square);
...
if (i % 3 === 0 && i % 5 === 0){
    ...
    const squareFizzBuzz = `<li style="background-color:#F0466F; padding:25px; color:black;"  class= "box mb-3 me-3 d-flex justify-content-center">FizzBuzz</li>`;
    ul.innerHTML += squareFizzBuzz;

} else if (i % 3 === 0) {
    const Fizz = `<li style="padding:25px;color:black;background-color:#0CD6A1;"  class= "box mb-3 me-3 d-flex justify-content-center">Fizz</li>`;
    ul.innerHTML += Fizz;

} else if (i % 5 === 0){
    const Buzz = `<li style="padding:25px;color:black;background-color:#FFD166;"  class= "box mb-3 me-3 d-flex justify-content-center">Buzz</li>`;
    ul.innerHTML += Buzz;
